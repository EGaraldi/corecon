...
Atek et al. (2022). The authors provide values in log(Z/Z_sun), which were converted to 12+log(O/H) following:
    12+log(O/H) = 12 + log( 0.35 * Z / 16 / 0.74 ) = 12 + log(Z/Z_sun) + log( 0.35 * Z_sun / 16 / 0.74 )
"""
...
values                 = [6.7545, 8.2645, 6.7345, 7.6545, 7.7345, 7.5145, 7.9845, 7.7845, 7.1445, 7.2545,
                          7.4645, 7.2745, 7.5545, 7.4145, 7.5745]
