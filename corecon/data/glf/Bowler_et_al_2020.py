...
axes                   = [[8.0, -21.65], [8.0, -22.15], [8.0, -22.90], [9.0, -21.9], [9.0, -22.9]]

values                 = [-5.526, -6.237, -6.854, -6.076, -6.796]

err_up                 = [0.123, 0.196, 0.155, 0.200, 0.227]

err_down               = [0.173, 0.365, 0.243, 0.380, 0.505]

upper_lim              = False

lower_lim              = False

left                   = [0.25, 0.25, 0.5, 0.5, 0.5]

right                  = [0.25, 0.25, 0.5, 0.5, 0.5]
